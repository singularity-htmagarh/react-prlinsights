      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-4 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              >
                <svg className="text-primary-foreground" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <ul className="space-y-2">
              <li>
                <Link 
                  ...
                  data-testid="link-footer-marketing-analytics"
                >
                  Marketing Analytics
                </Link>
              </li>
              <li>
                <Link 
                  href="/services" 
                  className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors duration-200"
                  data-testid="link-footer-media-optimization"
                >
                  Media Optimization
                </Link>
              </li>
              <li>
                <Link 
                  href="/services" 
                  className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors duration-200"
                  data-testid="link-footer-causal-inference"
                >
                  Causal Inference
                </Link>
              </li>
              <li>
                <Link 
                  href="/integration" 
                  className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors duration-200"
                  data-testid="link-footer-data-integration"
                >
                  Data Integration
                </Link>
              </li>
        ...
        <div className="border-t border-secondary-foreground/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a 
              href="#" 
              className="text-secondary-foreground/80 hover:text-secondary-foreground text-sm transition-colors duration-200"
